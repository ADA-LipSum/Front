...
export const MOCK_POSTS: AnnouncementPost[] = [
  {
    ...
    isPinned: true,
    category: '학사',
    title: '2026학년도 1학기 중간 강의평가 시행 안내',
    attachmentCount: 1,
    author: '학사지원팀',
    createdAt: '2026.06.01',
    viewCount: 3241,
    content:
      '2026학년도 1학기 중간 강의평가를 아래와 같이 시행합니다. 모든 재학생은 기간 내 강의평가를 완료해야 하며, 미완료 시 성적 열람이 제한됩니다.\n\n자세한 내용은 첨부파일 및 학교 포털을 통해 확인하실 수 있습니다. 문의사항은 담당 부서로 연락 바랍니다.',
  ...
  },
  {
    ...
    isPinned: true,
    category: '행사',
    title: '2026 봄 축제 "LINK PARK" 부스 운영 신청 모집',
    attachmentCount: 2,
    author: '종학생회',
    createdAt: '2026.05.30',
    viewCount: 5820,
    content:
      '2026 봄 축제 "LINK PARK"에 참여할 부스 운영을 신청하실 단체 및 개인을 모집합니다.\n\n신청 기간 및 운영 일정, 부스 배치 안내 등 자세한 내용은 첨부파일을 확인해 주세요.',
  ...
  },
  {
    ...
    isPinned: true,
    category: '서비스',
    title: 'ADA 거래소 오픈 & 코인/포인트 정책 안내',
    attachmentCount: 0,
    author: '운영팀',
    createdAt: '2026.05.28',
    viewCount: 4120,
    content:
      'ADA 거래소가 정식 오픈되었습니다. 코인 및 포인트 정책에 대한 상세 내용을 안내해 드립니다.\n\n거래소 이용 시 유의사항을 꼭 확인하시고, 문의사항은 운영팀으로 연락해 주세요.',
    attachments: [],
  },
  {
    id: 12,
    isPinned: false,
    category: '장학',
    title: '2026-1학기 국가장학금 2차 신청 기간 안내',
    attachmentCount: 1,
    author: '장학복지팀',
    createdAt: '2026.05.27',
    viewCount: 2890,
    content:
      '2026-1학기 국가장학금 2차 신청 기간을 안내해 드립니다.\n\n신청 기간 내 한국장학재단 홈페이지에서 신청하시기 바랍니다.',
  ...
  },
  {
    ...
    isPinned: false,
    category: '생활관',
    title: '여름방학 기숙사 신청 및 퇴사 일정 공지',
    attachmentCount: 1,
    author: '생활관',
    createdAt: '2026.05.25',
    viewCount: 1740,
    content:
      '여름방학 기숙사 신청 및 퇴사 일정을 안내해 드립니다.\n\n신청 기간 및 퇴사 절차를 첨부파일에서 확인해 주세요.',
  ...
  },
  {
    ...
    isPinned: false,
    category: '취업',
    title: '2026 상반기 캠퍼스 리크루팅 데이 개최',
    attachmentCount: 3,
    author: '취업지원센터',
    createdAt: '2026.05.24',
    viewCount: 2210,
    content:
      '2026 상반기 캠퍼스 리크루팅 데이가 개최됩니다.\n\n참가 기업 목록 및 일정표를 첨부파일에서 확인하시고, 관심 있는 학생들의 많은 참여 바랍니다.',
  ...
  },
  {
    ...
    isPinned: false,
    category: '학사',
    title: '2학기 수강신청 일정 및 유의사항 안내',
    attachmentCount: 1,
    author: '학사지원팀',
    createdAt: '2026.05.22',
    viewCount: 6510,
    content:
      '2학기 수강신청 일정 및 유의사항을 안내해 드립니다.\n\n신청 일정 및 방법을 반드시 숙지하신 후 신청해 주시기 바랍니다.',
  ...
  },
  {
    ...
    isPinned: false,
    category: '행사',
    title: '학생회 25기 중앙운영위원 모집 공고',
    attachmentCount: 2,
    author: '종학생회',
    createdAt: '2026.05.20',
    viewCount: 1980,
    content:
      '학생회 25기 중앙운영위원을 모집합니다.\n\n지원 자격 및 방법은 첨부 공고문을 참고해 주세요.',
  ...
  },
  {
    ...
    isPinned: false,
    category: '서비스',
    title: '서비스 점검에 따른 일시 접속 제한 안내',
    attachmentCount: 0,
    author: '운영팀',
    createdAt: '2026.05.18',
    viewCount: 920,
    content:
      '서비스 점검으로 인해 일시적으로 접속이 제한될 예정입니다.\n\n점검 시간 동안 불편을 드려 죄송합니다.',
    attachments: [],
  },
  {
    id: 6,
    isPinned: false,
    category: '장학',
    title: '교내 근로장학생 하계 모집 안내',
    attachmentCount: 1,
    author: '장학복지팀',
    createdAt: '2026.05.16',
    viewCount: 1530,
    content:
      '교내 근로장학생 하계 모집을 안내해 드립니다.\n\n지원 방법 및 일정은 첨부파일을 확인해 주세요.',
  ...
  },
  {
    ...
    isPinned: false,
    category: '생활관',
    title: '기숙사 호실 내 전열기구 사용 금지 재안내',
    attachmentCount: 0,
    author: '생활관',
    createdAt: '2026.05.14',
    viewCount: 680,
    content:
      '기숙사 호실 내 전열기구 사용이 금지되어 있음을 재안내해 드립니다.\n\n안전사고 예방을 위해 규정을 준수해 주시기 바랍니다.',
    attachments: [],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    isPinned: false,
    category: '학사',
    title: '2025학년도 성적 이의신청 처리 결과 안내',
    attachmentCount: 0,
    author: '학사지원팀',
      ...
      {posts.map((post) => {
        ...
        return (
          ...
          >
            ...
            <div>
              <span
                className={`inline-flex px-2.5 py-0.5 rounded-full text-[11px] font-semibold ${CATEGORY_COLORS[post.category]}`}
              >
                {post.category}
              </span>
            </div>
