...
const POPULAR_TAGS: Tag[] = [
  { label: '개발', count: '999+', color: 'bg-blue-50 text-blue-600 border-blue-200' },
  { label: '일상', count: '98', color: 'bg-green-50 text-green-600 border-green-200' },
  { label: '질문', count: '76', color: 'bg-yellow-50 text-yellow-600 border-yellow-200' },
  { label: '공유', count: '64', color: 'bg-purple-50 text-purple-600 border-purple-200' },
  { label: '스터디', count: '51', color: 'bg-pink-50 text-pink-600 border-pink-200' },
  { label: '취업', count: '43', color: 'bg-orange-50 text-orange-600 border-orange-200' },
  { label: '꿀팁', count: '38', color: 'bg-teal-50 text-teal-600 border-teal-200' },
  { label: '맛집', count: '29', color: 'bg-red-50 text-red-600 border-red-200' },
];
    ...
    <div className="flex flex-col gap-4 py-25 w-68">
      ...
      <div className="bg-white rounded-2xl border border-gray-300 overflow-hidden">
        <div className="px-4 pt-4 pb-3 flex items-center gap-2">
          <span className="text-sm font-semibold text-gray-700">인기 태그</span>
        </div>
